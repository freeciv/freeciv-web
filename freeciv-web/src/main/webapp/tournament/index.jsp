...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Freeciv-web Tournament</title>
...
<script>
  ...
  <body>
<a href="https://github.com/freeciv/freeciv-web"><img style="position: absolute; top: 0; right: 0; border: 0; z-index:5000;" src="https://s3.amazonaws.com/github/ribbons/forkme_right_red_aa0000.png" alt="Fork Freeciv on GitHub"></a>
...
<div id="body_content">
  ...
  <jsp:include page="tourny.jsp" flush="false"/>
