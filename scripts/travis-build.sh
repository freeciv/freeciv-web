...
tomcat_url="http://apache.uib.no/tomcat/tomcat-8/v8.5.16/bin/apache-tomcat-8.5.16.tar.gz"

# Based on fresh install of Ubuntu 14.04
dependencies="mysql-server-5.6 mysql-client-core-5.6 mysql-client-5.6 maven openjdk-7-jdk libcurl4-openssl-dev subversion pngcrush libtool automake autoconf autotools-dev language-pack-en python3-setuptools python3.4 python3.4-dev imagemagick liblzma-dev xvfb libicu-dev libsdl1.2-dev libjansson-dev dos2unix zip libsqlite3-dev"
