...
class StatusHandler(web.RequestHandler):
  ...
  def get(self):
    self.write("<h2>Freeciv-web Publite2 status</h2>" + 
               "<table><tr><td>Server limit:</td><td>" + str(self.metachecker.server_limit) + "</td></tr>" +
               "<tr><td>Server capacity:</td><td>" + str(self.metachecker.server_capacity) + "</td></tr>" +
               "<tr><td>Number of running servers:</td><td>" + str(len(self.metachecker.server_list)) + "</td></tr>"
               "<tr><td>Total servers on metaserver:</td><td>" + str(self.metachecker.total) + "</td></tr>" +
               "<tr><td>Single-player servers on metaserver:</td><td>" + str(self.metachecker.single) + "</td></tr>" +
               "<tr><td>Multi-player servers on metaserver:</td><td>" + str(self.metachecker.multi) + "</td></tr>" +
