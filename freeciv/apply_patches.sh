...
# multiplayer-darwin-fix is http://www.hostedredmine.com/issues/692096
# ai_assess_danger_distance_limit will speed up the AI by limiting the distance it will search for threatening enemy units.

PATCHLIST="freeciv_web_packets_def_changes city_impr_fix2 city-naming-change city_fixes2 metachange text_fixes unithand-change2 current_research_cost freeciv-svn-webclient-changes init_lists_disable goto_fcweb misc_devversion_sync tutorial_ruleset savegame maphand_ch ai_traits_crash server_password barbarian-names activity_null_check message_escape freeciv_segfauls_fix scorelog_filenames disable_global_warming win_chance navajo-remove-long-city-names webperimental_install webgl_vision_cheat_temporary user_changeable_gameseed multiplayer_movement_rates longturn max_map_size load_command_confirmation pragma_pack_city_length multiplayer-darwin-fix ai_assess_danger_distance_limit"
