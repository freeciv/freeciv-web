...
# virtualchangesnotsent is for Freeciv bug #23286.
# jsonparseerrormsg is for Freeciv bug #23347.
# activity_null_check is for Freeciv bug #22700.
# revert_5729 reverts patch #5729 for now, someone needs to make that to work
#    on freeciv-web.

PATCHLIST="virtualchangesnotsent jsonparseerrormsg freeciv_web_all_packets_def_changes caravan_fixes1 city_fixes city_impr_fix2 city_name_bugfix city-naming-change city_fixes2 citytools_changes revert_5729 goto_1 goto_attack1 goto_fix_1 goto_fix_2 govt-fix map-settings metachange orders_aborted orders_invalid2 text_fixes unithand-change2 webclient-ai-attitude current_research_cost freeciv-svn-webclient-changes network-rewrite-1 fcnet_packets misc_devversion_sync scenario_ruleset savegame savegame2 maphand_ch serverside_extra_assign libtoolize_no_symlinks spacerace city_disbandable ai_traits_crash unittools ruleset-capability worklists server_password aifill barbarian-names activity_null_check"
