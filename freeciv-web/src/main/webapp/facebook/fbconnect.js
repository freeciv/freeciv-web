...
function facebook_publish_feed_story(form_bundle_id, template_data) {
  // Load the feed form
  FB.ensureInit(function() {
	  FB.Connect.streamPublish(template_data , null,  null,  null,  "Invite your friends on Facebook to join your game on Freeciv.net",  done_callback,  true,  null);

  });
}

function done_callback(var1, var2)
{
