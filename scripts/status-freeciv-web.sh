...
wget -O /tmp/status7.log --quiet --spider --no-check-certificate http://localhost/game/list
if [ "$?" != 0 ]; then
  wget -O /tmp/status7.log --spider --no-check-certificate http://localhost/game/list 
