...
void main(void)
{
    ...
    if (terrain_type.r == terrain_grassland) {
      ...
      if (vPosition.y > beach_blend_high ) {
        chosen_terrain_color = texture2D(plains, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      } else {
        chosen_terrain_color = texture2D(coast, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      }
    } else if (terrain_type.r == terrain_lake) {
      if (vPosition.y < beach_blend_high ) {
        chosen_terrain_color = texture2D(lake, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      } else {
        chosen_terrain_color = texture2D(grassland, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      }
      ...
      chosen_terrain_color = texture2D(arctic, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
    } else if (terrain_type.r == terrain_desert) {
      if (vPosition.y > beach_blend_high ) {
        chosen_terrain_color = texture2D(desert, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      } else {
        chosen_terrain_color = texture2D(coast, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      }
    } else if (terrain_type.r == terrain_forest) {
      if (vPosition.y > beach_blend_high ) {
        chosen_terrain_color = texture2D(forest, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      } else {
        chosen_terrain_color = texture2D(coast, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      }
    } else if (terrain_type.r == terrain_hills) {
      if (vPosition.y > beach_blend_high ) {
        chosen_terrain_color = texture2D(hills, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      } else {
        chosen_terrain_color = texture2D(coast, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      }
    } else if (terrain_type.r == terrain_jungle) {
      if (vPosition.y > beach_blend_high ) {
        chosen_terrain_color = texture2D(jungle, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      } else {
        chosen_terrain_color = texture2D(coast, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      }
    } else if (terrain_type.r == terrain_mountains) {
      if (vPosition.y > beach_blend_high ) {
        chosen_terrain_color = texture2D(mountains, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      } else {
        chosen_terrain_color = texture2D(coast, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      }
    } else if (terrain_type.r == terrain_swamp) {
      if (vPosition.y > beach_blend_high ) {
        chosen_terrain_color = texture2D(swamp, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      } else {
        chosen_terrain_color = texture2D(coast, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      }
    } else if (terrain_type.r == terrain_tundra) {
      if (vPosition.y > beach_blend_high ) {
        chosen_terrain_color = texture2D(tundra, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      } else {
        chosen_terrain_color = texture2D(coast, vec2(vUv.x * map_x_size, vUv.y * map_y_size));
      }
    } else {
